...
if(db.connection){
    console.log('Order Not MySql connect !');
  }else{
    console.log("Order Mysql connected... ");
}
 * 
 */
...
db.connect((error) =>{
    if(error){
        console.log('Order Not MySql connect !' + error);
    }else{
        console.log("Order Mysql connected...");
    }
});
...
exports.GetOrder = async (req, res, next) => {
    try{
        ...
        sql += " 	SELECT	 ";
        sql += " 	    orders.orders_id	 ";
        sql += " 	    , orders_products.orders_products_id	 ";
        sql += " 	    , orders.customers_id	 ";
        sql += " 	    , orders_products.products_id	 ";
        sql += " 	    , orders_products.products_model	 ";
        sql += " 	    , orders_products.products_name	 ";
        sql += " 	    , orders_products.products_price	 ";
        sql += " 	    , orders_products.final_price	 ";
        sql += " 	    , orders_products.products_tax	 ";
        ...
        sql += " 	FROM	 ";
        sql += " 	    sigveng.orders	 ";
        sql += " 	    INNER JOIN sigveng.orders_products 	 ";
        sql += " 	        ON (orders.orders_id = orders_products.orders_id)	 ";
...
//SucessOrders
exports.SucessOrders = (req, res , next) => {
